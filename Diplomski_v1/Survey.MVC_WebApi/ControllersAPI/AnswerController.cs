...
namespace Survey.MVC_WebApi.ControllersAPI
{
  ...
  public class AnswerController : ApiController
  {
    ...
    public AnswerController(IAnswerRepository _AnswerRepository, IQuestionRepository _QuestionRepository, IPollRepository _PollRepository)
    {
    ...
    [Route("checkifvoted")]
    [HttpGet]
    public async Task<HttpResponseMessage> CheckIfUserVoted(string userId, Guid surveyId)
    {
      try
      {
        var entity = await AnswerRepository.CheckIfUserVoted(userId, surveyId);
        return Request.CreateResponse(HttpStatusCode.OK, entity);
      }
      catch (Exception e)
      {
